...
console.log(
  "This is a number guessing game, if you guess the correct number you earn 5 points,"
);
console.log(
  "But if you guess the wrong number the computer will automatically give you the hint"
);
console.log(
  "You will have three lives, means only two hints will be given to you"
);
...
if (answer1.guessedNumber === randomNumber) {
  console.log(
    "Congratulations!,You have guessed the correct number in first try.You have also earned 5 points "
  );
  process.exit();
...
if (answer2.guessedNumber === randomNumber) {
  console.log(
    "Congratulations!,You have guessed the correct number in second try.You have also earned 3 points "
  );
  process.exit();
...
if (answer3.guessedNumber === randomNumber) {
  console.log(
    "Congratulations!,You have guessed the correct number in third try.You have also earned 1 points "
  );
} else {
  console.log(
